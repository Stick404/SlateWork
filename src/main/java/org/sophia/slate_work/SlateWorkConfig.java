...
public class SlateWorkConfig implements ConfigData {
    @Comment("If set to true, Slate Works tries to aggressively optimize Spell Circle Looping, fixing a memory leak. This may break running Spell Circles, and may crash with addons that mixin to Spell Circles. Here be dragons! (enabled by default)")
