...
public class PatternRegistry {
    ...
    public static final HexPattern GET_CRAFT_COUNT = make("eaqwqaeqwaeadawwadaeawdaa", HexDir.SOUTH_WEST, "get_craft_count", OpGetCraftingCount.INSTANCE);
    public static final HexPattern SET_CRAFT_COUNT = make("eaqwqaeqwaeadawwadaeawedd", HexDir.SOUTH_WEST, "set_craft_count", OpSetCraftingCount.INSTANCE);
